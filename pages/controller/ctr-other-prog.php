...
if (isset($_POST['Save'])) {
    try {
        ...
        $message = $db->hasDuplicate('SELECT title, course_title FROM tbl_other_prog WHERE title = :title AND course_title = :course_title', [
            'title' => $_POST['title'],
        ...
        $db->executeInsert($sqlArray, 'tbl_other_prog');
...
if (isset($_POST['Edit'])) {
    try {
       ...
       // Decrypt the id
        ...
        $message = $db->hasDuplicate('SELECT title, course_title FROM tbl_other_prog WHERE title = :title AND course_title = :course_title AND sub_prog_id != :sub_prog_id', [
            'title' => $_POST['title'],
            'course_title' => $_POST['course_title'],
        ...
        // Execute the insert operation
        $db->executeUpdate($sqlArray, 'tbl_other_prog', 'sub_prog_id = :sub_prog_id', ['sub_prog_id' => $sub_prog_id]);
...
if (isset($_POST['Delete'])) {
    try {
        ...
        $db->executeDelete('tbl_other_prog', 'sub_prog_id = :sub_prog_id', ['sub_prog_id' => $id]);
