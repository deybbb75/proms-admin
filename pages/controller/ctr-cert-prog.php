...
if (isset($_POST['Edit'])) {
    try {
       ...
       // Decrypt the id
        ...
        $message = $db->hasDuplicate('SELECT title FROM tbl_cert_prog WHERE title = :title AND sub_prog_id != :sub_prog_id', [
            'title' => $_POST['title'],
        ...
        // Execute the insert operation
        $db->executeUpdate($sqlArray, 'tbl_cert_prog', 'sub_prog_id = :sub_prog_id', ['sub_prog_id' => $sub_prog_id]);
...
if (isset($_POST['Delete'])) {
    try {
        ...
        $db->executeDelete('tbl_cert_prog', 'sub_prog_id = :sub_prog_id', ['sub_prog_id' => $id]);
