            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#primary-header-modal"
                        onclick="addItem({fetch_name: 'fetch-assess-cert', custom_function: fetchCustom})">
                                ...
                                <td>
                                    <center>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#primary-header-modal"
                                            onclick="editItem({fetch_name: 'fetch-assess-cert', item_id: '<?= encrypt_data($line->ac_id) ?>', custom_function: fetchCustom})">
