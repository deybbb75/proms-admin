...
if(!isset($_SESSION['proms-admin']['expired_ay_id'])){
    $_SESSION['proms-admin']['expired_ay_id'] = $db->queryUniqueValue("SELECT ay_id FROM tbl_academic_year WHERE status = 'Active'");
}

if(isset($_POST['ay_id'])){
    $_SESSION['proms-admin']['expired_ay_id'] = $_POST['ay_id'];
    safe_redirect('pending.php');
}

console($_SESSION['proms-admin']['expired_ay_id']);
?>
<!-- Start Content-->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">EXPIRED RESERVATIONS</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12" style="margin-bottom: 30px;">
                            ...
                            <form action="" method="POST" id="acad_year" style="display: flex; gap: 10px;">
                                ...
                                ?>
                                    <option value="<?= $line->ay_id ?>" <?php if($_SESSION['proms-admin']['expired_ay_id'] == $line->ay_id) echo 'selected'; ?>>
                    ...
                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <?php
                                $reservation_query = $db->query("SELECT * FROM tbl_reservation WHERE ay_id = :ay_id AND status ='Expired'", ['ay_id' => $_SESSION['proms-admin']['expired_ay_id']]);
